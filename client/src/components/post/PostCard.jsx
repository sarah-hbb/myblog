...
const PostCard = ({ post }) => {
  return (
    <div>
      <div
        className="border border-gray-200 rounded-md mb-4 relative w-96 h-60
      ...
      >
       ...
       bg-black bg-opacity-65 rounded-b-md"
          >
            <h1
       ...
       "
            >
              ...
              ad, quis possimus aut provident laboriosam quam dolorem
              perferendis ipsa eaque consectetur aspernatur accusantium
              distinctio vel iure qui vitae optio tempora!
            </h1>
